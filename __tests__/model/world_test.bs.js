...
var World$ReasonGof = require("../../src/model/world.bs.js");

function draw(world) {
  return World$ReasonGof.fold_left((function (param, param$1) {
                  var y = param$1[0][/* y */1];
                  var prevY = param[1];
                  var tmp;
                  if (prevY) {
...
describe("World", (function () {
        Jest.test("create 1x1 without seed", (function () {
                return expectWorld(World$ReasonGof.create(1, 1, /* array */[]), "\n      -\n    ");
              }));
        Jest.test("create 2x2 without seed", (function () {
                return expectWorld(World$ReasonGof.create(2, 2, /* array */[]), "\n      --\n      --\n      ");
              }));
        Jest.test("create 2x3 without seed", (function () {
                return expectWorld(World$ReasonGof.create(3, 2, /* array */[]), "\n      ---\n      ---\n      ");
              }));
        ...
        describe("step", (function () {
                var expectStepsToEqual = function (steps, expected) {
                  var world = World$ReasonGof.create(4, 3, /* array */[
                        /* record */[
                          /* x */2,
                          /* y */0
                        ],
                  ...
                  $$Array.iter((function () {
                          return World$ReasonGof.step(world);
